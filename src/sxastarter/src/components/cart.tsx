...
interface CartItem {
  ...
  export const Default = (): JSX.Element => {
    ...
    {id:"Laptop Model XYZ" ,image:'https://images.pexels.com/photos/6446709/pexels-photo-6446709.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',name:"Laptop Model XYZ",price:101888, quantity:1},
    ];
    const [totalAmount, setTotalAmount] = useState<number>(products.reduce((a, c) => a + c.quantity * c.price, 0));
            ...
            <ul>
              ...
              <li>
                <button
                  ...
                  onClick={()=>{confirmCartEvent(siteInfo,language)}}
                >
                  Check Out
                </button>
              </li>
